...
global.channelLink = "https://whatsapp.com/channel/0029Vb7MFotEKyZQpmFM7Y0I";
global.ytch = "Cyber Sensei";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7MFotEKyZQpmFM7Y0I'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\nhttps://chat.whatsapp.com/KVtxslee41h1jmnSRB49ez`
                }, { quoted: message });
                return;
            }
        }
